...
#validaciones Especiale

    if(!empty($_POST['Tipo']) and $_POST['Tipo']=='Movil'){
        if(!empty($_POST['Unidad']) and $_POST['Unidad']=='Unidad'){
            $validacion_de_campos['Validacion_general']=false;
            $validacion_de_campos['noDefaul']['Unidad']=false;
            $validacion_de_campos['noDefaul']['validacion']=false;
        }
    }
#swchis maestros 
